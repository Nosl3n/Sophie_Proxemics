...
/** \mainpage RoboComp::sophieProxemic
 *
 * \section intro_sec Introduction
 *
 * The sophieProxemic component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/sophieProxemic --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class sophieProxemic : public RoboComp::Application
{
public:
	sophieProxemic (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::sophieProxemic::initialize()
{
...
int ::sophieProxemic::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::sophieProxemic app(prefix, startup_check_flag);
